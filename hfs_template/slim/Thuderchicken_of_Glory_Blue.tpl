...
<head>
	...
	<meta name="description" content="HFS">
        <title>HFS %folder% -- Harrell</title>
	<style>%style%</style>
			...
			<table cellspacing=0 cellpadding=0 border=0 width="100%">
				...
				<tr>
					<td class=infobox align=left>
						&#8226;&nbsp;<a href="http://www.autoitx.com" target=_blank" onmouseover="popUp(event,'t5')">AutoitX</a><br>
					</td>
				</tr>
			</table>
		</div>
...
<div align=center>
	生成页面耗时: %build-time% 秒&nbsp;&#8226;&nbsp;<a href="#">定位到页面顶端</a>&nbsp;&#8226;
</div>
