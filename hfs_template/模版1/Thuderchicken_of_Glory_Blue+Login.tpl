...
[login-link]
<div class=content  align=center style="margin: 0 auto;margin-top:5%;width:400px;text-align:center;text-align:left;width:80%;">
	<table cellspacing=0 cellpadding=0 border=0 width="100%">
		<tr>
			<th colspan=3 class=infohder align=center>Login</th>
		</tr>
		<tr>
			<td  class=infobox style="padding-left:5px;border-right:0px">基本服务器信息:<br>**** 在此输入信息 ****<br><br>如果你不是会员,你可以用 "<b>guest</b>"作为用户名和密码登陆, 游客账户仅拥有最基本权限.<br><br>要获得更高权限请<a href="mailto: **** 输入Email ****" onmouseout="popUp(event,'t1')" onmouseover="popUp(event,'t1')"><b>注册为会员</b></a>.<br><br>				
			<center>
				<a href="%encoded-folder%~login"><div class=navbar style="border:1px solid #036;cursor:pointer;">登陆到: %host%</div></a>
			</center>
			</td>
			<td class=infobox align=left width=150>在线时长:<br>%uptime%<br><br>连接数: %connections%<br>连入: %speed-in% KB/s<br>连出: %speed-out% KB/s<br><br>当前本地时间: %timestamp%<br><br>您的IP:<br>%ip%</td>
			<td  class=infobox align=center style="padding-left:5px;border-left:0px;"><a href="/~progress" target=_blank onmouseout="popUp(event,'t3')" onmouseover="popUp(event,'t3')"><img src="/~img_graph300x135" alt="Graph" style="border:1px solid #fff;"></a>
			</td>
		</tr>
	</table>
</div>
